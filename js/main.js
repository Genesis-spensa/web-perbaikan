      ...
      articles.forEach(function (a) {
        ...
        articleEl.innerHTML = `
          ...
          <div class="summary-row">
            <p class="news-summary" data-full-summary="${fullSummary.replace(/"/g, '&quot;')}">${shortSummary}</p>
            <button type="button" class="read-more-toggle-text read-more-toggle" aria-expanded="false">*Baca selengkapnya*</button>
          </div>
        `;
